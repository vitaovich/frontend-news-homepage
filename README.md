...
```bash
az staticwebapp create -n StarterNextJSTailwindCSS -g StarterNextJS -s https://github.com/<YOUR_GITHUB_USERNAME>/frontend-news-homepage -l WestUs2 -b main --login-with-github
```
...
```bash 
https://github.com/<YOUR_GITHUB_USERNAME>/frontend-news-homepage/actions
```
...
``` bash
sed -i "s/frontend-news-homepage/<your project name>/" package.json package-lock.json README.md
chmod u+x setup.sh
```
